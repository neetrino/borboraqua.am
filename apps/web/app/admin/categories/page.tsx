            ...
            return (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  <ProductPageButton
                    variant="outline"
                    className="h-7 px-2 text-[10px] font-medium flex items-center justify-center gap-0.5 text-blue-600 border-blue-300 hover:bg-blue-50"
                  ...
                  <ProductPageButton
                    variant="outline"
                    className="h-7 px-2 text-[10px] font-medium flex items-center justify-center gap-0.5 text-red-600 border-red-300 hover:bg-red-50"
