    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="relative">
        ...
        <div className="bg-[rgba(135, 135, 135, 0.05)] backdrop-blur-[5px] rounded-[34px] p-8 md:p-10 sm:p-6 border border-[rgba(255,255,255,0)] overflow-clip text-center">
          <div className="mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-red-100/80 backdrop-blur-sm border border-red-200/50">
            <svg
          ...
          {messageFromQuery && (
            <div className="mb-6 p-3 bg-red-50/80 backdrop-blur-sm border border-red-200/50 rounded-[12px]">
