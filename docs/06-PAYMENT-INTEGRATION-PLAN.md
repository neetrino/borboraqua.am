...
## 2. Callback URL-ներ (պարտադիր path-եր)
...
## 3. Ինտեգրացիայի հերթականություն
...
6. Ըստ արդյունքի թարմացնել order, redirect օգտատիրոջ success/fail էջ։
...
- EDP_REC_ACCOUNT (test/live), SECRET_KEY (test/live) — տես 7.
...
## 9. Առաջին քայլ — Ameriabank

1. **Env** — ավելացնել Ameriabank-ի բոլոր դաշտերը (տես 8), test placeholder-ներով։
